        ...
        try {
            ...
            if (code.equals("1")) {
                ...
                for (int i = 0; i < bodyArray.length(); i++) {
                    ...
                    itemCategories.setName(bodyObject
                            .getString(Constants._NAME));
                    itemCategories.setAvg_cost(bodyObject.getString("avg_cost"));
                    itemCategories.setTime(bodyObject.getString("time"));
                    itemCategories.setDificulty_type(bodyObject.getString("dificulty_level"));
                    arrayList.add(itemCategories);
